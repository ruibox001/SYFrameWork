...
+(NSString *)pathForHomeDirectoryWithPath:(NSString *)path
{
    return [[FCFileManager pathForHomeDirectory] stringByAppendingString:path];
}
...
// Jimmy Add
+(NSArray *)readSubPathAtPath:(NSString *)path
{
